...
const fixtureDir=mkdtempSync(join(tmpdir(),'form-studio-cli-'));
const fixture=join(fixtureDir,'screenshot.png');
writeFileSync(fixture,Buffer.from('iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNk+A8AAQUBAScY42YAAAAASUVORK5CYII=','base64'));
...
r=cli(['render',fixture,'--dry-run','--device','iphone15','--device-y','-0.2','--rotate-y','-42','--camera','Isometric','--fov','24','--lighting','Moody','--screen-y','-0.7','--zoom','1.4','--background','gradient','--no-ground','--ratio','9:16','--resolution','2160','--transparent']);
